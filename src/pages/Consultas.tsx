...
const Consultas: React.FC = () => {
  ...
  // URL do Typebot para Consultas
  const typebotUrl = userEmail ? `https://typebot.co/consultas-vixus?email=${userEmail}` : 'about:blank';
        ...
        <Card className="flex-1 overflow-hidden border border-[#A7CF17] rounded-xl mb-6">
          <CardContent className="h-full w-full p-0">
            ...
            {userEmail && (
              <iframe
                src={typebotUrl}
                title="Assistente de Consultas Vixus"
