...
// O componente principal da página de saldo (integrado ao dashboard)
const SaldoDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <h3 className="text-xl font-semibold mb-4 text-foreground">Cadastrar Nova Conta</h3>
      ...
      <Card className="p-6">
        <h3 className="text-xl font-semibold mb-4 text-foreground">Minhas Contas</h3>
        {loading ? (
