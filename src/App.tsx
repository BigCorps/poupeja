...
import BancosConectados from './pages/BancosConectados'; // Importação da nova página
                    ...
                    <BrowserRouter>
                      <SupabaseInitializer>
                        <Routes>
                          ...
                          <Route path="/dashboard" element={<SaldoDashboard />} />
                          ...
                          <Route path="/bancos-conectados" element={<BancosConectados />} />
